...
const menus = [
  ...
  {
    name: 'UtilsResponsiveEmbed',
    path: '/utilsresponsiveembed',
    active: false
  },
...
export default function Menu() {
  ...
  const conMenu = menus.map(m=>{
    
    return(
      <MenuItems key={m.path} name={m.name} path={m.path} active={window.location.pathname===m.path }/>
    )
  });
